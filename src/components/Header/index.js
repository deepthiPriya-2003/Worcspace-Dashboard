    ...
    return (
        ...
        <div className = "flex items-center justify-between bg-gradient-to-r from-[#1E1B4B] via-[#2e2978] to-[#1E1B4B] text-white h-16 rounded p-2 w-full">
            ...
            <div className="flex items-center justify-items-start">
             <img src="https://res.cloudinary.com/dzxmezrqp/image/upload/v1775052441/aventisia-logo_zwbtwm.png" alt="logo" className="h-12 w-10 rounded"/>
         ...
         <input type="search" className="bg-[#605d8f] w-96 h-6 px-4 border-none outline-none focus-outline-none" placeholder="Search... " />
